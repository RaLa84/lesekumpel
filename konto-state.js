    ...
    setChildren([
      {
        ...
        /* avatar.v2 = gestalteter Held-Avatar (Baukasten in kind.html, Enums in avatar-svg.js):
           { typ:'mensch'|'tier'|'fantasie', name, mensch:{hautton,frisur,haarfarbe,brille,hoergeraet,oberteil,accessoire},
             tier:{tier,fellfarbe,muster}, fantasie:{wesen,farbe,merkmal}, updatedAt }
