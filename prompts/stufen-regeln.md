...
- **TEMPUS:** Präsens
- **SYNTAX:** Hauptsätze
- **FOKUS:** Wörter mit Konsonantenclustern: bl, gr, kn, pf, str, schr, spr
- **WORTANZAHL:** 40–60 Wörter

## Stufe 2.3 — Endungen (-en, -er, -el)
- **TEMPUS:** Präsens
- **SYNTAX:** Hauptsätze
- **FOKUS:** Zweisilbige Wörter mit Endungen -en, -er, -el
- **WORTANZAHL:** 40–60 Wörter

## Stufe 2.4 — Komposita (Nomen + Nomen)
- **TEMPUS:** Präsens
- **SYNTAX:** Hauptsätze
- **FOKUS:** Zusammengesetzte Nomen (max. 2 Teile): Haustür, Schlüsselbund, Hundehütte
- **WORTANZAHL:** 40–60 Wörter
...
- **FOKUS:** Starke/unregelmäßige Verben: lief, kam, sah, ging, fand, nahm, stand, sprach
...
- **GRAMMATIK:** Passiv-Konstruktionen: wird gemacht, wurde gebaut, ist hergestellt worden
- **STIL:** Nüchtern, informativ — Sachtext, KEIN Erzähltext mit Figuren
- **FOKUS:** Fakten, Erklärungen, logischer Aufbau, unpersönliches "man"
- **WORTANZAHL:** 200–300 Wörter
